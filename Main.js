...
const T = {
  en: {
    ...
    about_q_rest:' — the complete cycle, from complex math to a deployed container.',
  ...
  de: {
    ...
    about_q_rest:' — der komplette Zyklus, von komplexer Mathematik bis zum produktiv eingesetzten Container.',
